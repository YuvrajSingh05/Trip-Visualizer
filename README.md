...
Open the folder in your editor (usually File > Open Folder).
...
If the project is an Angular application, you can use the ng serve command to run it locally. First, make sure you have Angular CLI installed globally:
